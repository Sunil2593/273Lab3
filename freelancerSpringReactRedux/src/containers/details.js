    ...
    renderItem() {
        ...
        if (project != null) {
            ...
            <div>
                    ...
                    Skill Required: {project.skills_required}<br/>
                    Budget Range: {project.budget_range}<br/>
                    Status: {project.status}<br/>
                    Estimate Project Completion Date: {project.estimate_project_completion_date.toString().slice(0,10)}<br/><br/>
...
function mapStateToProps(state) {
    return {
        selectedProjectBids:state.selectedprojectbids.bids
    };
}
